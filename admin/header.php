...
<div class="flex min-h-screen">
    ...
    <aside id="sidebar" class="w-64 bg-nightwing-900/95 backdrop-blur-xl border-r border-neon-blue/10 flex flex-col fixed inset-y-0 left-0 z-[60] md:z-40 -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out">
        ...
        <nav class="flex-1 p-4 space-y-1 overflow-y-auto">
            <a href="./" class="sidebar-link <?= $current_page === 'index.php' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-lg text-sm text-gray-400 font-medium">
            ...
            <a href="about_form" class="sidebar-link <?= $current_page === 'about_form.php' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-lg text-sm text-gray-400 font-medium">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z"/></svg>
                About
            </a>
            <a href="skills" class="sidebar-link <?= in_array($current_page, ['skills.php', 'skill_form.php']) ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-lg text-sm text-gray-400 font-medium">
            ...
            <a href="contact_form" class="sidebar-link <?= $current_page === 'contact_form.php' ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-lg text-sm text-gray-400 font-medium">
            ...
            <p class="px-4 pt-4 pb-1 text-gray-700 text-[10px] uppercase tracking-widest font-orbitron">Data</p>
            <a href="projects" class="sidebar-link <?= in_array($current_page, ['projects.php', 'project_form.php']) ? 'active' : '' ?> flex items-center gap-3 px-4 py-3 rounded-lg text-sm text-gray-400 font-medium">
