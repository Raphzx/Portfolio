...
<div class="mb-8">
    <h1 class="font-orbitron text-2xl md:text-3xl font-bold text-white mb-2">Sektion About</h1>
    <p class="text-gray-500 text-sm">Kelola teks, statistik, dan fitur di bagian tentang Anda.</p>
</div>

<?php if (isset($_GET['saved'])): ?>
    <div class="mb-6 px-4 py-3 rounded-lg bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-sm">Sektion About berhasil disimpan.</div>
<?php endif; ?>
    ...
    <form method="POST" action="" class="space-y-8">
        ...
        <div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    <label class="block text-gray-400 text-sm font-medium mb-2">Nomor</label>
                ...
                <div>
                    <label class="block text-gray-400 text-sm font-medium mb-2">Judul Kartu</label>
            ...
            <div class="mt-6 space-y-4">
                <div>
                    <label class="block text-gray-400 text-sm font-medium mb-2">Paragraf 1</label>
                ...
                <div>
                    <label class="block text-gray-400 text-sm font-medium mb-2">Paragraf 2</label>
        ...
        <div class="border-t border-neon-blue/10 pt-6">
            <div class="flex items-center justify-between mb-4">
                <h2 class="font-orbitron text-lg font-bold text-white">Statistik</h2>
                <button type="button" onclick="addStat()" class="text-neon-blue hover:text-cyan-400 text-sm transition-colors">+ Tambah Statistik</button>
            </div>
        ...
        <div class="border-t border-neon-blue/10 pt-6">
            <div class="flex items-center justify-between mb-4">
                <h2 class="font-orbitron text-lg font-bold text-white">Fitur</h2>
                <button type="button" onclick="addFeature()" class="text-neon-blue hover:text-cyan-400 text-sm transition-colors">+ Tambah Fitur</button>
            </div>
            <div id="featuresWrap" class="space-y-4">
                <?php foreach ($features as $i => $f): ?>
                    <div class="glass-card rounded-xl p-4 feature-row">
                        <div class="flex items-start justify-between gap-3 mb-2">
                            <p class="text-gray-500 text-xs uppercase tracking-wider">Fitur <?= $i + 1 ?></p>
                        ...
                        <div class="space-y-2">
                            <input type="text" name="feat_title[]" value="<?= htmlspecialchars($f['title']) ?>"
                                   class="input-field-admin w-full rounded-lg px-3 py-2 text-white placeholder-gray-600" placeholder="Judul Fitur">
                            <textarea name="feat_desc[]" rows="2"
                                      class="input-field-admin w-full rounded-lg px-3 py-2 text-white placeholder-gray-600 resize-none" placeholder="Deskripsi fitur"><?= htmlspecialchars($f['description']) ?></textarea>
...
function addFeature() {
    ...
    div.innerHTML =
        '<div class="flex items-start justify-between gap-3 mb-2">' +
        '<p class="text-gray-500 text-xs uppercase tracking-wider">Fitur Baru</p>' +
        '<button type="button" onclick="this.closest(\'.feature-row\').remove()" class="text-red-400 hover:text-red-300 transition-colors">' +
        ...
        '<div class="space-y-2">' +
        '<input type="text" name="feat_title[]" class="input-field-admin w-full rounded-lg px-3 py-2 text-white placeholder-gray-600" placeholder="Judul Fitur">' +
        '<textarea name="feat_desc[]" rows="2" class="input-field-admin w-full rounded-lg px-3 py-2 text-white placeholder-gray-600 resize-none" placeholder="Deskripsi fitur"></textarea>' +
