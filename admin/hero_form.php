...
<div class="mb-8">
    <h1 class="font-orbitron text-2xl md:text-3xl font-bold text-white mb-2">Hero Section</h1>
    <p class="text-gray-500 text-sm">Manage the text displayed at the top of your portfolio.</p>
</div>

<?php if (isset($_GET['saved'])): ?>
    <div class="mb-6 px-4 py-3 rounded-lg bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-sm">Hero section saved successfully.</div>
<?php endif; ?>
...
<div class="glass-card rounded-2xl p-6 md:p-8 max-w-5xl">
    <form method="POST" action="" class="space-y-6">
        ...
        <div>
            <label class="block text-gray-400 text-sm font-medium mb-3">Title (3 lines)</label>
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    <p class="text-gray-600 text-xs mb-1">Line 1</p>
                ...
                <div>
                    <p class="text-gray-600 text-xs mb-1">Line 2 (gradient)</p>
                    <input type="text" name="title_2" maxlength="100"
                           value="<?= htmlspecialchars($hero['title_2']) ?>"
                           class="input-field-admin w-full rounded-lg px-4 py-3 text-white placeholder-gray-600">
                </div>
                <div>
                    <p class="text-gray-600 text-xs mb-1">Line 3</p>
        ...
        <div>
            ...
            <textarea name="subtitle" rows="2"
                      ...
                      placeholder="Brief hero description"><?= htmlspecialchars($hero['subtitle']) ?></textarea>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="glass-card rounded-xl p-4">
                <p class="text-gray-500 text-xs uppercase tracking-wider mb-3">Button 1</p>
                <div class="space-y-3">
            ...
            <div class="glass-card rounded-xl p-4">
                <p class="text-gray-500 text-xs uppercase tracking-wider mb-3">Button 2</p>
                <div class="space-y-3">
