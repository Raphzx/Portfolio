...
<div class="mb-8">
    ...
    <p class="text-gray-500 text-sm">Selamat datang kembali, <span class="text-neon-blue"><?= htmlspecialchars($_SESSION['username']) ?></span>. Kelola portfolio Anda di sini.</p>
</div>
...
<div class="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8">
    ...
    <div class="glass-card rounded-2xl p-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-gray-500 text-xs uppercase tracking-wider">Ada Demo</p>
    ...
    <div class="glass-card rounded-2xl p-6">
        <div class="flex items-center gap-4">
            ...
            <div>
                <p class="text-gray-500 text-xs uppercase tracking-wider">Ada Source</p>
