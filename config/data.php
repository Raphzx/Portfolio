...
define('HERO', [
    ...
    'cta_1'     => ['text' => 'View Projects',  'href' => '#projects'],
    'cta_2'     => ['text' => 'Contact Me',     'href' => '#contact'],
]);
...
define('ABOUT', [
    ...
    'features' => [
        [
            'icon_code' => 'M17.25 6.75L22.5 12l-5.25 5.25m-10.5 0L1.5 12l5.25-5.25m7.5-3l-4.5 16.5',
            'title'     => 'Clean Code',
            'desc'      => 'Writing structured, readable, and easy-to-maintain code.',
        ],
        [
            'icon_code' => 'M9.53 16.122a3 3 0 00-5.78 1.128 2.25 2.25 0 01-2.4 2.245 4.5 4.5 0 008.4-2.245c0-.399-.078-.78-.22-1.128zm0 0a15.998 15.998 0 003.388-1.62m-5.043-.025a15.994 15.994 0 011.622-3.395m3.42 3.42a15.995 15.995 0 004.764-4.648l3.876-5.814a1.151 1.151 0 00-1.597-1.597L14.146 6.32a15.996 15.996 0 00-4.649 4.763m3.42 3.42a6.776 6.776 0 00-3.42-3.42',
            'title'     => 'UI/UX Design',
            'desc'      => 'Designing clean, responsive, and user-friendly interfaces.',
        ],
        [
            'icon_code' => 'M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z',
            'title'     => 'Performance',
            'desc'      => 'Ensuring fast loading times and smooth overall web application performance.',
        ],
    ],
]);
...
define('SKILLS', [
    ...
    'items' => [
        ['name' => 'JavaScript', 'level' => 45, 'icon' => "assets/logo/javascript.png"],
        ['name' => 'React / Next.js',         'level' => 30, 'icon' => "assets/logo/react.png"],
        ['name' => 'Node.js',       'level' => 23, 'icon' => "assets/logo/nodejs.png"],
        ['name' => 'PHP / Laravel',           'level' => 90, 'icon' => "assets/logo/laravel.png"],
        ['name' => 'Python',         'level' => 50, 'icon' => "assets/logo/python.png"],
        ['name' => 'Database MySql',    'level' => 85, 'icon' => "assets/logo/mysql.png"],
        ['name' => 'Tailwind CSS',         'level' => 70, 'icon' => "assets/logo/tailwind.png"],
        ['name' => 'UI/UX Design',            'level' => 82, 'icon' => "assets/logo/ux-design.png"],
...
define('CONTACT', [
    ...
    'socials' => [
        ...
        ['platform' => 'Twitter',   'url' => '#', 'path' => 'M23.953 4.57a10 10 0 01-2.825.775 4.958 4.958 0 002.163-2.723c-.951.555-2.005.959-3.127 1.184a4.92 4.92 0 00-8.384 4.482C7.69 8.095 4.067 6.13 1.64 3.162a4.822 4.822 0 00-.666 2.475c0 1.71.87 3.213 2.188 4.096a4.904 4.904 0 01-2.228-.616v.06a4.923 4.923 0 003.946 4.827 4.996 4.996 0 01-2.212.085 4.936 4.936 0 004.604 3.417 9.867 9.867 0 01-6.102 2.105c-.39 0-.779-.023-1.17-.067a13.995 13.995 0 007.557 2.209c9.053 0 13.998-7.496 13.998-13.985 0-.21 0-.42-.015-.63A9.935 9.935 0 0024 4.59z'],
    ],
]);
